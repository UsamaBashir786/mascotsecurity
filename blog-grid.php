        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="blog-grid.php"> Blog List Style</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                            ...
                            <div class="post-card-2 card-3 inner-blog">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title"><a href="blog-details.php">Technical Wizardry of Our Web Design Agency</a></h3>
                            ...
                            <div class="post-card-2 card-3 inner-blog">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title"><a href="blog-details.php">Strategies for Effective Web Design by Our Agency</a></h3>
                                        <p>Where online presence defines success, our agency stands at the forefront of crafting web experiences that transcend mere aesthetics. Our web design strategies are built upon a foundation of user-centricity, innovation, and a deep understanding of your brand.</p>
                                        <a href="blog-details.php" class="rr-primary-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                    </div>
                                </div>
                            ...
                            <div class="post-card-2 card-3 inner-blog">
                                ...
                                <div class="post-content-wrap">
                                    <div class="post-content">
                                        ...
                                        <h3 class="title"><a href="blog-details.php">Ensures Your Website Rises to the Top of Search Rankings</a></h3>
                                        <p>Where online presence defines success, our agency stands at the forefront of crafting web experiences that transcend mere aesthetics. Our web design strategies are built upon a foundation of user-centricity, innovation, and a deep understanding of your brand.</p>
                                        <a href="blog-details.php" class="rr-primary-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                    </div>
                                </div>
