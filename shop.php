        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    <h1 class="title">Our Shop Pages</h1>
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="shop.php"> Our Shop Page</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->

        <section class="shop-section pt-130 pb-130">
            <div class="container">
                <div class="shop-top heading-space">
                    <span class="left-content">Showing 1 - 12 of 30 Results</span>
                    <div class="nice-select select-control country" tabindex="0"><span class="current">Short by Category</span><ul class="list"><li data-value="" class="option selected focus">Short by Category</li><li data-value="vdt" class="option">Plan One</li><li data-value="can" class="option">Plan Two</li><li data-value="uk" class="option">Plan Three</li></ul></div>
                </div>
                <div class="row gy-4">
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                ...
                                <h3 class="title"><a href="shop-details.php">Multiply Tokon Maxer</a><span> <span class="offer">$350.00</span>$250.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                ...
                                <h3 class="title"><a href="shop-details.php">Boat Headphone</a><span>$350.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                ...
                                <h3 class="title"><a href="shop-details.php">Latest Ups available</a><span> <span class="offer">$250.00</span>$157.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                <span class="category">Headphone Box</span>
                                <h3 class="title"><a href="shop-details.php">Beats Headset</a><span>$342.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                <span class="category">Watch Series</span>
                                <h3 class="title"><a href="shop-details.php">Multiply Tokon Maxer</a><span>$223.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                <span class="category">Headphone Box</span>
                                <h3 class="title"><a href="shop-details.php">Boat Headphone</a><span> <span class="offer">$600.00</span>$421.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                <span class="category">UPS Service</span>
                                <h3 class="title"><a href="shop-details.php">Latest Ups available</a><span>$153.00</span></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="shop-item">
                            ...
                            <div class="shop-content">
                                <span class="category">Headphone Box</span>
                                <h3 class="title"><a href="shop-details.php">Beats Headset</a><span><span class="offer">$400.00</span>$230.00</span></h3>
                            </div>
                        </div>
                    </div>
                </div>
