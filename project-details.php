        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="project-details.php"> Mobile Application Development</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                        ...
                        <div class="project-details-content">
                            ...
                            <div class="project-details-items">
                                ...
                                <div class="project-details-item">
                                    ...
                                    <div class="content">
                                        <span>Category:</span>
                                        <h4 class="item-title">Digital Marketing, SEO</h4>
                                    </div>
                                </div>
                                <div class="project-details-item">
                                    ...
                                    <div class="content">
                                        <span>Date:</span>
                                        <h4 class="item-title">25 March, 2023</h4>
                                    </div>
                                </div>
                                <div class="project-details-item">
                                    ...
                                    <div class="content">
                                        <span>Address:</span>
                                        <h4 class="item-title">258 Dancing Street, USA</h4>
                                    </div>
                                </div>
                            </div>
                            <h3 class="details-title mb-30">Mobile Application Development</h3>
                            <p class="mb-30">Lorem ipsum dolor sit amet consectetur adipiscing, elit nunc eleifend duis sociosqu augue imperdiet, metus varius at dignissim malesuada. Nisi pharetra felis ullamcorper diam rutrum justo lectus ligula aptent, dapibus egestas habitasse habitant velit platea eget penatibus facilisi fusce, dictumst torquent sagittis porttitor nunc orci posuere praesent. Penatibus tincidunt erat odio augue sed platea, dapibus mauris hendrerit felis morbi duis, ornare lacinia sodales convallis sollicitudin. Sociosqu pulvinar tempus vel laoreet interdum porttitor commodo, vivamus congue sagittis aenean turpis nullam diam, bibendum habitant nam non varius orci.</p>
                            <p>Accumsan dui id justo fusce vehicula inceptos dignissim potenti elementum iaculis, nibh suspendisse ultricies nisl aptent sodales vitae eros vulputate. Gravida sollicitudin bibendum nascetur facilisis platea feugiat parturient mauris, erat habitant metus conubia lobortis tempor elementum augue, tempus taciti convallis aptent ridiculus primis neque.</p>
                            <div class="row project-details-wrap">
                                <div class="col-lg-8 col-md-12">
                                    <div class="project-details-left">
                                        <div class="details-item">
                                            <h3 class="details-title">01. The Challenge</h3>
                                            <p>Turpis odio nascetur vel suscipit proin vestibulum bibendum tempor. Curabitur aliquam sociis risus parturient faucibus ornare magnis nascetur mauris, bibendum convallis vestibulum purus tincidunt eleifend litora. Leo magnis egestas conubia fringilla justo platea pharetra cubilia phasellus hac tristique proin, eget nascetur fermentum lacus mi arcu habitant facilisis odio eleifend vitae. Dignissim nostra hendrerit suscipit platea condimentum suspendisse montes porttitor, commodo potenti laoreet dictumst rutrum senectus luctus nulla.</p>
                                        </div>
                                        <div class="details-item">
                                            <h3 class="details-title">02. The Solution</h3>
                                            <p class="desc mb-30">Sollicitudin justo morbi cubilia penatibus congue integer parturient ante class luctus, urna scelerisque potenti eget curae velit tincidunt cras consequat, accumsan cursus gravida malesuada sociosqu egestas convallis quam elementum. Maecenas risus curae sodales dictum bibendum in gravida, <span>primis sollicitudin eleifend posuere rhoncus torquent blandit lectus, metus dignissim class viverra scelerisque habitant.</span></p>
                                            <p>Pellentesque malesuada consequat vestibulum ante quam placerat, sed bibendum aliquam magnis vulputate mus. Neque viverra feugiat tincidunt fermentum dapibus vitae leo nec dis pulvinar, morbi justo mus mattis gravida nostra massa dictum class mi inceptos, proin quisque litora rhoncus scelerisque arcu quis accumsan commodo.</p>
                                        </div>
                                        <div class="details-item">
                                            <blockquote>
                                        ...
                                        <div class="details-item">
                                            ...
                                            <p>Primis inceptos phasellus commodo conubia blandit mus neque quis, mi suspendisse vivamus cum dapibus aenean feugiat quisque consequat, leo nostra netus nisl tortor dictum massa. Pretium viverra proin tristique augue taciti ligula ante congue, habitasse magnis nunc erat cubilia lobortis scelerisque vehicula dictumst, ut nam suspendisse a nibh inceptos porta. Inceptos cum sed sapien lectus ornare venenatis ullamcorper magna, est conubia orci libero ultricies purus nec, non cubilia tempus malesuada lacus nibh dictumst.</p>
                                        </div>
                                    </div>
                                </div>
