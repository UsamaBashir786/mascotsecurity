        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    <h1 class="title">Portfolio Grid 2 Columns</h1>
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="project.php"> Portfolio Grid 2 Columns</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                    ...
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">Medical Application Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">Dashboard App Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">Business Task Management</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">NFT Landing Page Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">Universe Landing Page Design</a></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="cs-item fade-top">
                            ...
                            <div class="cs-content">
                                ...
                                <h3 class="title"><a href="project-details.php">Payment App Design</a></h3>
                            </div>
                        </div>
                    </div>
                </div>
