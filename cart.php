        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="cart.php"> Cart Page</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
        ...
        <div class="cart-box pb-130">
            <div class="container">
                ...
                <div class="checkout-proceed">
                    <a href="checkout.php" class="rr-primary-btn checkout-btn">Proceed to Checkout</a>
                </div>
            </div>
        </div>
