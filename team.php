        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><a class="inner-page" href="team.php">Our Team</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                ...
                <div class="row gy-5 fade-wrapper">
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Charlotte Amitina</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Hannah Chloe</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Maiselan Willam</a></h3>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Sophia Williams</a></h3>
                                <span>Ui/Ux Designer</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Isabella Anderson</a></h3>
                                <span>Project Manager</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Jonathan Clark</a></h3>
                                <span>Product Designer</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="team-item fade-top">
                            ...
                            <div class="team-content">
                                <h3 class="title"><a href="team-details.php">Amelia Clark</a></h3>
                                <span>Web Developer</span>
                            </div>
                        </div>
                    </div>
