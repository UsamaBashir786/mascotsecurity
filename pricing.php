        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="pricing.php"> Pricing Plans</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="pricing-item">
                                        ...
                                        <div class="pricing-btn-wrap">
                                            <a href="contact.php" class="rr-primary-btn pricing-btn">Get in Touch <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                            <a href="pricing.php" class="rr-primary-btn pricing-btn">View Details <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                        </div>
