        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><span></span><a class="inner-page" href="faq.php"> Frequently Asked Questions</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                        ...
                        <div class="post-card-2 card-3">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">Redefining User Experience with Our Web Design Agency...</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="post-card-2 card-3">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">Why Prioritizes User Experience in Every Web Design Project</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="post-card-2 card-3">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">Demystifying the Wizardry of Our Web Design Agency</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
