        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="https://html.rrdevs.net/">Home </a><span></span><a class="inner-page" href="service.php"> Our Services</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
        ...
        <section class="service-section pt-130 pb-130">
            <div class="container">
                <div class="row gy-5">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item md-pb-30">
                            <h4 class="service-text"><a href="service-details.php">/Branding</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item md-pb-30">
                            <h4 class="service-text"><a href="service-details.php">/Consulting</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item item-3">
                            <h4 class="service-text"><a href="service-details.php">/Software</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item">
                            <h4 class="service-text"><a href="service-details.php">/Optimization</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
        ...
        <section class="service-cta">
            ...
            <div class="container">
                <div class="service-cta-wrap">
                    ...
                    <a href="contact.php" class="rr-primary-btn cta-btn">Make Appointment <i class="fa-regular fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
        <!-- ./ service-cta -->
