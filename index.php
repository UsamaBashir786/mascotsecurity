    ...
    <div id="smooth-wrapper">
        ...
        <section class="hero-section">
            ...
            <div class="container">
                <div class="hero-content">
                    ...
                    <a href="about.php" class="hero-btn"><i class="fa-thin fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
        <!-- ./ hero-section -->
        ...
        <section class="process-section pt-130 fade-wrapper">
            ...
            <div class="process-text wow fade-in-bottom" data-wow-delay="400ms">
                ...
                <img class="process-img-light light-img" src="assets/img/images/process-img-light.png" alt="process">
            </div>
        </section>
        <!-- ./ process-section -->
                    ...
                    <div class="col-lg-7">
                        <div class="about-content fade-wrapper">
                            <div class="section-heading mb-0">
                                ...
                                <p class="fade-top">Digital marketing is the act of promoting and selling products and services by leveraging online marketing tactics such as social media marketing, search marketing, and email marketing. When you get down to it, digital marketing is simply marketing.</p>
                                <div class="about-btn fade-top">
                                    <a href="about.php" class="rr-primary-btn">Get Started Now<i class="fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row gy-lg-0 gy-4">
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item md-pb-30 fade-top">
                            <h4 class="service-text"><a href="service-details.php">/Designing</a></h4>
                            <div class="service-thumb">
                                ...
                                <a href="service-details.php" class="service-btn">Read Details <i class="fa-regular fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item md-pb-30 fade-top">
                            <h4 class="service-text"><a href="service-details.php">/Development</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item item-3 fade-top">
                            <h4 class="service-text"><a href="service-details.php"> /User Experience</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="service-item fade-top">
                            <h4 class="service-text"><a href="service-details.php">  /Mobile Solution</a></h4>
                            <div class="service-thumb">
                                <div class="overlay-color"></div>
                                <div class="transparent-shape"><img src="assets/img/shapes/service-shape.png" alt="shape"></div>
            ...
            <div class="container">
                <div class="project-top heading-space align-items-end fade-wrapper">
                    ...
                    <div class="project-top-btn fade-top">
                        <a href="project.php" class="rr-primary-btn">View More Project<i class="fa-regular fa-arrow-right"></i></a>
                    </div>
                </div>
                                ...
                                <div class="accordion-body">
                                    <div class="hover-content">
                                        <div class="content-left">
                                            ...
                                            <a href="project-details.php" class="rr-primary-btn">View Details<i class="fa-regular fa-arrow-right"></i></a>
                                        </div>
                        ...
                        <div class="post-card">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">The Future-Focused Strategies of Our Forward-Thinking Web Design Agency</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn blog-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="post-card">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">A Deep Dive into the Impactful Branding Strategies of Our Web Design Agency</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn blog-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="post-card">
                            ...
                            <div class="post-content-wrap">
                                <div class="post-content">
                                    ...
                                    <h3 class="title"><a href="blog-details.php">How Our Web Design Agency Ensures Your Website Rises to the Top of Search Rankings</a></h3>
                                    <a href="blog-details.php" class="rr-primary-btn blog-btn">Read More <i class="fa-sharp fa-regular fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
