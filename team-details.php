        ...
        <section class="page-header" data-background="assets/img/bg-img/page-header-bg.jpg">
            ...
            <div class="container">
                <div class="page-header-content text-center">
                    ...
                    <h4 class="sub-title"><a class="home" href="index.php">Home </a><a class="inner-page" href="team-details.php">Team Details</a></h4>
                </div>
            </div>
        </section>
        <!-- ./ page-header -->
                ...
                <div class="row author-wrap align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="author-content">
                            <h2 class="name">Richard John <span>Founder & CEO</span></h2>
                            <p>Sem consequat mauris conubia inceptos nostra rutrum morbi sagittis pulvinar, commodo curabitur  maecenas fermentum magna tempus nisi ullamcorper, ante auctor magnis pretium eu lectus euismod platea. Congue sociosqu nostra est urna pellentesque placerat euismod bibendum.</p>
                            <div class="author-items">
                                <div class="author-item">
                                    <div class="icon"><i class="fa-solid fa-user"></i></div>
                                    <div class="content">
                                        <h4><span>Experience</span>More Than 10 Years</h4>
                                    </div>
                                </div>
                                <div class="author-item">
                                    <div class="icon"><i class="fa-sharp fa-solid fa-envelope"></i></div>
                                    <div class="content">
                                        <h4><span>Email</span><a href="mailto:info@agency.com">info@agency.com</a></h4>
                                    </div>
                                </div>
                                <div class="author-item">
                                    <div class="icon"><i class="fa-sharp fa-solid fa-phone"></i></div>
                                    <div class="content">
                                        <h4><span>Phone</span><a href="tel:+2565862169581">+(256) 58621-69581</a></h4>
                                    </div>
                                </div>
                                <div class="author-item">
                                    <div class="icon"><i class="fa-sharp fa-solid fa-fax"></i></div>
                                    <div class="content">
                                        <h4><span>Fax</span><a href="fax:+2568145632">+2568145632</a></h4>
                                    </div>
                                </div>
                            </div>
                            <a href="#" class="rr-primary-btn">Contact Me</a>        
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="expertise-content">
                            <div class="section-heading">
                                <h4 class="sub-heading after-none" data-text-animation="fade-in" data-duration="1.5">Our team Expertise</h4>
                                <h2 class="section-title" data-text-animation data-split="word" data-duration="1">We have Lot of Experience and Professionals</h2>
                                <p>Inceptos nostra rutrum morbi sagittis pulvinar, commodo curat maecenas fermentum magna tempus nisi ullamcorper, ante auctor magnis pretium eu lectus euismod platea. Congue sociosqu nostra est urna pellentesque placerat.</p>
                            </div>
                            <ul class="details-progress">
                                ...
                                <li class="skills-item">
                                    <h5 class="title">Application Design</h5>
                                    <div class="progress">
